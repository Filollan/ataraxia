      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.statsGrid}>
          ...
          >
            ...
            <Text
              style={[
                ...
                {
                  color:
                    lockState.penaltiesCount > 0 ? colors.danger : colors.text,
                  fontFamily: theme.typography.fontFamily.bold,
                },
              ]}
            >
          ...
          >
            ...
            >
              {creationStats.totalJournals +
                creationStats.totalAudios +
                creationStats.totalDrawings}
            </Text>
            <Text style={[styles.statsSubtext, { color: colors.textMuted }]}>
              Total de creaciones guardadas
            </Text>
          </View>
        </View>
        ...
        {isLocked ? (
          <>
            ...
            <View style={styles.toolsContainer}>
              ...
              >
                <View
                  style={[styles.toolIconBg, { backgroundColor: "#F59E0B15" }]}
                >
                  <IconSymbol
          ...
          <View style={styles.unlockedNotice}>
            <Text
              style={[styles.unlockedNoticeText, { color: colors.textMuted }]}
            >
              El bloqueo no está activo. Puedes navegar por las redes sociales o
              activar manualmente el bloqueo arriba para forzar una sesión
              creativa.
            </Text>
          </View>
        )}
